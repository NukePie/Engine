...
{
	//Set to windowed mode to avoid exceptions and clean up
	if(m_swapChain)
	{
...
void D3DClass::BeginScene(float red, float green, float blue, float alpha)//Initializes the buffers and make then ready to be drawn to (blank)
{
	float color[4];
...
//This functions get pointers to the direct3D Device and device context

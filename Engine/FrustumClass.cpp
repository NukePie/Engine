...
void FrustumClass::ConstructFrustum(float screenDepth, D3DXMATRIX projectionMatrix, D3DXMATRIX viewMatrix)
{
	...
	// Create the frustrum matrix from the view matrix and the updated projection matrix.
...
bool FrustumClass::CheckPoint(float x, float y, float z)
{
	...
	// Check if the point is in side all six planes of the view frustrum.
	for(i = 0; i < 6; i++)
	{
...
bool FrustumClass::CheckCube(float xCenter, float yCenter, float zCenter, float radius)
{
	...
	// Check if any one point of the cube is in the view frustrum.
	for(i = 0; i < 6; i++)
	{
...
bool FrustumClass::CheckSphere(float xCenter, float yCenter, float zCenter, float radius)
{
	...
	// Check if the radius of the sphere is inside of the view frustrum.
	for(i = 0; i < 6; i++)
	{
...
bool FrustumClass::CheckRectangle(float xCenter, float yCenter, float zCenter, float xSize, float ySize, float zSize)
{
	...
	// Check if any of the 6 planes of the rectangle are inside the view frustrum.
	for(i = 0; i < 6; i++)
	{
